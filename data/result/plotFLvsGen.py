...
# 测试精度
with open('./GEN10nodesNew/GMA_test_acc_all_epoch100.pkl', 'rb') as f:
    y_gen = pickle.load(f)
with open('./FL10nodesNew/FL_test_acc_all_epoch100.pkl', 'rb') as f:
    y_fl = pickle.load(f)
...
def plotCenter():
    ...
    plt.plot(x_data, gaussian_filter1d(y_gen, sigma=1), label='GenFL')
    plt.plot(x_data, gaussian_filter1d(y_fl, sigma=1), label='FL')
