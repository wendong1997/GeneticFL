...
# 验证精度
with open('./FL10nodesNT/FL_val_acc_avg_epoch100.pkl', 'rb') as f:
    y_fl = pickle.load(f)
with open('Central10nodesNT/val_acc_epoch100.pkl', 'rb') as f:
    y_cen = pickle.load(f)

# # 测试精度
# # with open('./GEN100nodes/GMA_test_acc_all_epoch100.pkl', 'rb') as f:
# #     y_gen = pickle.load(f)
# with open('./FL10nodesNT/FL_test_acc_all_epoch100.pkl', 'rb') as f:
#     y_fl = pickle.load(f)
# with open('Central10nodesNT/test_acc_epoch100.pkl', 'rb') as f:
#     y_cen = pickle.load(f)
